...
class VPM_AF_Admin_Email extends WC_Email {
	...
	private function init() {
		...
		// Subject & heading
		$this->subject = __( 'Fraud notification of order #{order_id}', 'vpm-anti-fraud' );
		$this->heading = __( 'Fraud notification of order #{order_id}', 'vpm-anti-fraud' );

		// Set recipients
		$this->recipient =  'info@vpm.com';
